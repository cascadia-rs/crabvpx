static mut dc_qlookup: [::core::ffi::c_int; 128] = [
    4 as ::core::ffi::c_int,
    5 as ::core::ffi::c_int,
    6 as ::core::ffi::c_int,
    7 as ::core::ffi::c_int,
...
static mut ac_qlookup: [::core::ffi::c_int; 128] = [
    4 as ::core::ffi::c_int,
    5 as ::core::ffi::c_int,
    6 as ::core::ffi::c_int,
    7 as ::core::ffi::c_int,
...
#[unsafe(no_mangle)]
pub unsafe fn vp8_ac_yquant(mut QIndex: ::core::ffi::c_int) -> ::core::ffi::c_int {
    unsafe {
        let mut retval: ::core::ffi::c_int = 0;
        if QIndex > 127 as ::core::ffi::c_int {
            QIndex = 127 as ::core::ffi::c_int;
...
pub unsafe fn vp8_ac2quant(
    ...
    unsafe {
        ...
        retval = (ac_qlookup[QIndex as usize] * 101581 as ::core::ffi::c_int)
            >> 16 as ::core::ffi::c_int;
