...
#[inline]
unsafe fn arm_cpu_env_flags(mut flags: *mut ::core::ffi::c_int) -> ::core::ffi::c_int { unsafe {
...
#[inline]
unsafe fn arm_cpu_env_mask() -> ::core::ffi::c_int { unsafe {
    let mut env: *const ::core::ffi::c_char =
...
unsafe fn arm_get_cpu_caps() -> ::core::ffi::c_int { unsafe {
...
#[unsafe(no_mangle)]
pub unsafe fn arm_cpu_caps() -> ::core::ffi::c_int { unsafe {
    let mut flags: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
