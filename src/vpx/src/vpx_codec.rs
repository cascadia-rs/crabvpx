...
#[unsafe(no_mangle)]
pub unsafe fn vpx_codec_version_str() -> *const ::core::ffi::c_char {
    VERSION_STRING_NOSP.as_ptr()
}
#[unsafe(no_mangle)]
pub unsafe fn vpx_codec_version_extra_str() -> *const ::core::ffi::c_char {
...
#[unsafe(no_mangle)]
pub unsafe fn vpx_codec_err_to_string(
    mut err: vpx_codec_err_t,
) -> *const ::core::ffi::c_char {
    match err as ::core::ffi::c_uint {
        0 => return b"Success\0" as *const u8 as *const ::core::ffi::c_char,
        1 => {
            return b"Unspecified internal error\0" as *const u8 as *const ::core::ffi::c_char;
        }
        2 => {
            return b"Memory allocation error\0" as *const u8 as *const ::core::ffi::c_char;
        }
        3 => return b"ABI version mismatch\0" as *const u8 as *const ::core::ffi::c_char,
        4 => {
            return b"Codec does not implement requested capability\0" as *const u8
                as *const ::core::ffi::c_char;
        }
        5 => {
            return b"Bitstream not supported by this decoder\0" as *const u8
                as *const ::core::ffi::c_char;
        }
        6 => {
        ...
        7 => {
            return b"Corrupt frame detected\0" as *const u8 as *const ::core::ffi::c_char;
        }
        8 => return b"Invalid parameter\0" as *const u8 as *const ::core::ffi::c_char,
...
pub unsafe fn vpx_codec_destroy(mut ctx: *mut vpx_codec_ctx_t) -> vpx_codec_err_t {
    unsafe {
        ...
        if ctx.is_null() {
            ...
            (*ctx).name = ::core::ptr::null::<::core::ffi::c_char>();
...
#[unsafe(no_mangle)]
pub unsafe fn vpx_codec_get_caps(
    mut iface: *const vpx_codec_iface_t,
) -> vpx_codec_caps_t {
    unsafe {
        if !iface.is_null() {
