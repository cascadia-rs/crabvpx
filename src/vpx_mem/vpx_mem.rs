...
unsafe extern "C" fn get_malloc_address_location(mem: *mut ::core::ffi::c_void) -> *mut size_t {
...
#[no_mangle]
pub unsafe extern "C" fn vpx_malloc(mut size: size_t) -> *mut ::core::ffi::c_void {
    return vpx_memalign(DEFAULT_ALIGNMENT, size);
}
#[no_mangle]
pub unsafe extern "C" fn vpx_calloc(mut num: size_t, mut size: size_t) -> *mut ::core::ffi::c_void {
...
#[no_mangle]
pub unsafe extern "C" fn vpx_free(mut memblk: *mut ::core::ffi::c_void) {
    if !memblk.is_null() {
